...
import com.miracle.smart_ecommerce_security.domain.order.service.ShippingMethodService;
...
public class ShippingMethodController {
    ...
    public ResponseEntity<ApiResponse<Page<ShippingMethodResponse>>> list(@PageableDefault(size = 10) Pageable pageable) {
