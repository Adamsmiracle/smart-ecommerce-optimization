...
public class User extends BaseModel {
    ...
    /**
     * BCrypt-hashed password. Null for OAuth2 users — they authenticate via Google
     * and never set a local password. Validation is enforced at the service layer
     * for non-OAuth2 registration instead of at the entity level.
     */
