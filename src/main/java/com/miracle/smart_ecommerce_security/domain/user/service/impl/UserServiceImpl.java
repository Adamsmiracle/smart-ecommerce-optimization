...
public class UserServiceImpl implements UserService {
    ...
    /**
     * Create a new user.
     * Evicts all user cache entries so new user appears in listings.
     */
    @Override
     ...
     * Cached by page + size + sort to serve repeated admin listing requests from cache.
     */
    @Override
    @Transactional(readOnly = true)
    ...
    public Page<UserResponse> searchUsers(String keyword, Pageable pageable) {
        ...
        return userRepository.search(keyword, pageable).map(this::mapToResponse);
    }

    /**
     * Update an existing user.
     * Updated entry cached by both ID and email; all list entries evicted.
     */
    @Override
    @Transactional(rollbackFor = Exception.class)
    @Caching(
