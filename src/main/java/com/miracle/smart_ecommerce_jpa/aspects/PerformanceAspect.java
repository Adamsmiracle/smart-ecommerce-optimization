...
public class PerformanceAspect {
     ...
     */
    @Pointcut("within(com.miracle.smart_ecommerce_jpa..service..*)")
    public void serviceLayerMethods() {}

    /**
     * Pointcut for all controller methods (matches project package)
     */
    @Pointcut("within(com.miracle.smart_ecommerce_jpa..controller..*)")
    public void controllerMethods() {}

    /**
     * Pointcut for all repository methods (matches project package)
     */
    @Pointcut("within(com.miracle.smart_ecommerce_jpa..repository..*)")
