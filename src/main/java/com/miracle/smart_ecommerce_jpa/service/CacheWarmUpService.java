...
public class CacheWarmUpService {
    ...
    public CompletableFuture<Void> performFullWarmUp() {
        ...
        CompletableFuture<Void> productsWarmUp = cacheManagementService.warmUpProductCache();
        CompletableFuture<Void> usersWarmUp = cacheManagementService.warmUpUserCache();
        CompletableFuture<Void> categoriesWarmUp = cacheManagementService.warmUpCategoryCache();
        ...
        return CompletableFuture.allOf(
            ...
            log.info("Manual full cache warm-up completed for all caches");
        }).exceptionally(e -> {
